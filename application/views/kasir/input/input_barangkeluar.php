  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Stok Terjual" name="stok_terjual">
     <?php if (validation_errors()): ?>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Harga Terjual" name="harga_terjual">
     <?php if (validation_errors()): ?>
