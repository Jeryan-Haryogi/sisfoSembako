            ...
            <div class="content">
            	   ...
            	   <div class="container">
            	   	...
            	   	<?php foreach ($detil as $key => $assa): ?>
							    ...
							    <input type="text" class="form-control" value="<?= $assa['nama_penerima'] ?>" name="nama_penerima">
							    ...
							    <input type="text" class="form-control" value="<?= $assa['stok_terjual'] ?>" name="stok">
							    <?php if (validation_errors()): ?>
							    ...
							    <input type="text" class="form-control"value="<?= $assa['harga_terjual'] ?>"   name="harga">
							     <?php if (validation_errors()): ?>
