        ...
        <section class="section">
          <div class="row ">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Masukan Stok Barang" name="stok_keluar">
              <?php if (validation_errors()): ?>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Masukan Harga Masuk" name="harga_keluar">
              <?php if (validation_errors()): ?>
